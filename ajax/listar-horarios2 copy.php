...
if($total_reg2 == 0 || strtotime($hora_rec) == strtotime($hora)){
	...
	if(strtotime($dataH) != strtotime($data) and $dataH != "" and $dataH != "null"){
		continue;
				...
				<?php
// Dentro do seu loop que gera os horários...
// Supondo que você tenha as variáveis $hora, $horaF, $esconder, $hora_agendada, $checado, $texto_hora

// Cria um ID único para o radio e o label usando a hora (removendo os dois pontos)
$id_unico_hora = "radio_hora_" . str_replace(':', '', $hora);

?>

<div class="col-3 hora-item" style="display: <?php echo $esconder ?>;" data-hora="<?php echo htmlspecialchars($hora); ?>">

    <div class="form-check form-switch">
        <input class="form-check-input"
               type="radio"
               role="switch"
               id="<?php echo $id_unico_hora; ?>"  
               name="hora"  
        ...
        <label class="form-check-label <?php echo $texto_hora; ?>"
               for="<?php echo $id_unico_hora; ?>"
