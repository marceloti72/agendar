...
$whats = '55'.preg_replace('/[ ()-]+/' , '' , $telefone_pessoa);
		 ...
		 echo '<li>';
             echo '<a href="#" class="item-link item-content" onclick="editarReceber('.$id.', \''.$descricao.'\', \''.$valorF.'\', \''.$nome_pessoa.'\', \''.$data_vencF.'\', \''.$data_pgtoF.'\', \''.$tumb_arquivo.'\', \''.$nome_usuario_lanc.'\', \''.$nome_usuario_pgto.'\', \''.$foto.'\', \''.$ext.'\', \''.$oc.'\', \''.$classe_cor_whats.'\', \''.$telefone_pessoa.'\', \''.$whats.'\')">'; 
