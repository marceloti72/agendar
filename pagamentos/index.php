...
if ($ref_pix != "") {
    ...
    if ($status_api == 'approved') {
        echo "<script>window.location='$url/pagamentos/pagamento_aprovado3.php?id_agd=$id_pg'&id_conta=$id_conta</script>";
        exit();
    }
}
...
<body class="text-center">
    ...
    <script>
        ...
        function check(id, id_conta) {
            var settings = {
                "url": "<?= $url; ?>pagamentos/process_payment.php?acc=check&id=" + id + "&id_agd=" + id_conta,
                "method": "GET",
                "timeout": 0
            };
