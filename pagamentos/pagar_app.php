...
$query = $pdo->query("SELECT * FROM receber where id = '$id_receber'");
...
if ($ref_pix != "") {
    ...
    if ($status_api == 'approved') {
        echo "<script>window.location='$url/pagamentos/pagamento_aprovado_app.php?id_pg=$id_receber'&id_conta=$id_conta</script>";
        exit();
    }
}
...
<body class="text-center">
    ...
    <form action="agendamento_confirmado" method="post" style="display:none">
        <input type="hidden" name="id" value="<?= $id_receber; ?>">
    ...
    <div style="max-width: 500px; max-height: 800px; margin: 0 auto;  text-align: center; margin-bottom: 20px; word-break: break-all;">
        ...
        <div id="info_pagamento" style="text-align: center;">
            <p class="h3 font-weight-normal" style=" font-size: 21px; border-radius: 4px;"><span><b>Comanda - </span><span style="color:green; ">R$ <?= $valorF; ?></b></span> </p>
