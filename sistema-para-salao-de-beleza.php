...
<section class="content" >
    ...
    <div class="text">
        ...
        <p>Diga adeus às dores de cabeça na hora de organizar sua agenda. Com o MARKAI, seu salão de beleza ganha um sistema fácil, rápido e completo para gerenciar horários e otimizar o dia a dia.</p>
        <div class="buttons">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="section-card">
                    ...
                    <p>Domingo de manhã, o cliente quer MARKAI um corte para a semana, mas o seu estabelecimento está fechado. E se você estiver de férias, como fica o controle do negócio? Com nossa solução em nuvem, os clientes marcam horários a qualquer momento, e você acompanha tudo em tempo real, de qualquer lugar. Seu salão de beleza nunca para!.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="section-card">
                    ...
                    <p>Manter seus clientes voltando é chave para o seu salão de beleza crescer. Estudos apontam que fidelizar pode ser 5 vezes mais econômico do que buscar novos clientes. Com o MARKAI, mensagens automáticas de retorno são enviadas no dia perfeito, garantindo que eles não se esqueçam de você.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="section-card">
                    ...
                    <p>Leve seu salão de beleza mais longe com um site próprio! O MARKAI cria um site pra você customizar com horários, localização, serviços, produtos e fotos. Seus clientes te encontram nas buscas e agendam direto – uma ponte perfeita entre você e quem quer seus serviços!</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="section-card">
                    ...
                    <p>Já tem um site ou uma página no Facebook de seu salão de beleza? Dê um passo além: adicione o link de Agendamento Online do MARKAI! É mais um canal pra facilitar a vida dos seus clientes e turbinar seus agendamentos.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="section-card">
                    ...
                    <p>O consumo online avança 90% por ano, mudando rapidinho como os clientes consomem. Adote o pagamento online com o MARKAI: você protege seu lucro contra ausências, incentiva o cliente a comparecer (quem paga antes não perde!), oferece praticidade e posiciona seu salão de beleza numa tendência mundial com tecnologia confiável.</p>
                </div>
            </div>
