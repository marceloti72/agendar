...
<style>
    ...
    /* Modal Container for modalForm2 */
    .modal-content {
        border-radius: 12px;
    ...
    /* Pagamento Section for modalForm2 */
    .pagamento-container {
        display: flex;
        flex-direction: column;
        height: 100%;
    ...
    .pagamento-header:hover .pagamento-icon {
        transform: scale(1.1);
    }

    /* Divider for modalForm2 */
    .divider {
        margin: 1.5rem 0;
        border-top: 1px solid #e5e7eb;
    }

    /* Section Header for modalForm2 */
    .section-header {
        display: flex;
        align-items: center;
        gap: 8px;
    ...
    /* Item List Container for modalForm2 */
    .item-list-container {
        margin-bottom: 1.5rem;
    }

    /* Form Elements for modalForm2 */
    .form-group {
        margin-bottom: 1rem;
    }
    ...
    /* Responsive Adjustments for modalForm2 */
    ...
    /* Custom Modal Header for modalForm and modalServico */
    .modal-header-custom {
        background-color: #3b82f6;
        color: #fff;
        border-bottom: none;
    ...
    /* Modal Body Content for modalForm and modalServico */
    .modal-body {
        padding: 1.5rem;
        color: #4b5563;
    }
    ...
    /* Section Divider for modalForm and modalServico */
    .section-divider {
        border-bottom: 1px solid #e5e7eb;
        margin: 1.5rem 0;
    }

    /* Details Sections for modalForm and modalServico */
    .details-section {
        margin-bottom: 1.5rem;
    }
...
<div class="row">
    <div class="col-md-3">
        <button style="margin-bottom:10px; border-radius: 10px;box-shadow: 4px 4px 6px rgba(0, 0, 0, 0.4)" data-toggle="modal" data-target="#modalForm" type="button" class="btn novo">
        ...
        <div class="modal-content">
            <div class="modal-header modal-header-custom">
                <h4 class="modal-title" id="titulo_comanda">
                    <i class="fas fa-cash-register modal-icon"></i> Nova Comanda
                </h4>
                            ...
                            <div class="modal-body-scroll p-3">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-2 d-flex align-items-end">
                                        <button type="button" class="btn btn-success btn-add" id="botao-inserir-servico" onclick="inserirServico()">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-2 d-flex align-items-end">
                                        <button type="button" class="btn btn-success btn-add" id="botao-inserir-produto" onclick="inserirProduto()">
                                            <i class="fa fa-plus"></i> Adicionar
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4 modal-right-panel">
                            <div class="pagamento-container p-3">
                                <div class="pagamento-header">
                                    <i class="fas fa-cash-register pagamento-icon"></i>
                                    <h4>PAGAMENTO</h4>
                                </div>
                                ...
                                <div class="d-flex flex-column gap-2 mt-4">
                                    <a href="#" id="btn_fechar_comanda" class="btn btn-success btn-lg" onclick="fecharComanda()">
...
<script>
    ...
    function inserirServico() {
        ...
        if($botaoOriginal.length) {
            $botaoOriginal.prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i> Inserindo...');
        }
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response && response.success) {
                    ...
                    if(typeof listarServicos2 === 'function') {
            ...
            complete: function() {
                if($botaoOriginal.length) {
                    $botaoOriginal.prop('disabled', false).html('<i class="fa fa-plus"></i> Adicionar');
                }
            }
        });
    }
    ...
    function inserirProduto() {
        ...
        var $botaoOriginal = $('#botao-inserir-produto');
        if($botaoOriginal.length) {
            $botaoOriginal.prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i> Inserindo...');
        }
