...
$query = $pdo->query("SELECT * FROM $tabela where comanda_id = '$id' and id_conta = '$id_conta'");
...
$pdo->query("DELETE FROM $tabela where comanda_id = '$id' and id_conta = '$id_conta'");
$pdo->query("DELETE FROM horarios_agd where agendamento = '$id_agenda' and id_conta = '$id_conta'");
$pdo->query("DELETE FROM comandas where id = '$id' and id_conta = '$id_conta'");
$pdo->query("DELETE FROM pagar where comanda = '$id' and id_conta = '$id_conta'");
