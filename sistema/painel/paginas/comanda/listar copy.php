...
$query = $pdo->query("SELECT * FROM $tabela where data >= '$dataInicial' and data <= '$dataFinal' and status LIKE '$status' and funcionario = '$usuario_logado' and id_conta = '$id_conta' ORDER BY id asc");
...
if ($total_reg > 0) {
	for ($i = 0; $i < $total_reg; $i++) {
		...
		echo <<<HTML
			<div class="col-xs-12 col-md-3 widget cardTarefas" id="comanda_p" style = 'border-radius: 20px;box-shadow: 4px 4px 6px rgba(0, 0, 0, 0.4)'>
