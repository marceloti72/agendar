...
if($funcionario == ""){
	$query = $pdo->query("SELECT * FROM $tabela where data_lanc >= '$dataInicial' and data_lanc <= '$dataFinal' and pago LIKE '$status' and tipo = 'Comissão' ORDER BY pago asc, data_venc asc");
}else{
