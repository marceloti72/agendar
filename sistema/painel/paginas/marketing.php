...
<div class="">      
	<a class="btn btn-dark novo" onclick="inserir()" style = 'border-radius: 10px;box-shadow: 4px 4px 6px rgba(0, 0, 0, 0.4); margin-top: 10px;'><i class="fa fa-plus" aria-hidden="true"></i> Nova Campanha</a>
</div>
