...
$query = $pdo->query("SELECT * FROM marketing where id = '$id' and id_conta = '$id_conta'");
...
// $url_audio = $url."sistema/painel/img/marketing/".$audio;
// if($audio != ""){
...
//salvar hashs
$pdo->query("UPDATE marketing SET envios = '$envios', data_envio = curDate(), hash = '$hash', hash2 = '$hash2', hash3 = '$hash3', forma_envio = '$clientes' where id = '$id' and id_conta = '$id_conta'");
