...
<style>
        ...
        @media (max-width: 768px) {
            ...
            .table th:nth-child(4), .table td:nth-child(4) { width: 10%; } /* Ações */
...
HTML;
	...
	for ($i = 0; $i < $total_reg; $i++) {
		...
		if ($data_pgto == null || $data_pgto == '0000-00-00') {
...
<td>
		...
		<!-- <li class="dropdown head-dpdn2" style="display: inline-block;">
		<a title="Baixar Conta" href="#" class="dropdown-toggle {$visivel}" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-check-square verde"></i></a>
