...
<td>
		...
		<a href="http://api.whatsapp.com/send?1=pt_BR&phone=$whats&text=" target="_blank" title="Abrir Whatsapp" class="btn btn-success btn-xs"><i class="fab fa-whatsapp" style='font-size:18px;' ></i></a>
