...
<body>
	...
	<div class="mx-2">
		...
		<?php
		$total_entradas = 0;
		$query = $pdo->query("SELECT * FROM pagar where data_pgto >= '$dataInicial' and data_pgto <= '$dataFinal' and tipo LIKE '$filtro' and pago = 'Sim' and id_conta = '$id_conta' ORDER BY data_pgto asc");
