...
$query2 = $pdo->query("SELECT * FROM clientes where id = '$id' and id_conta = '$id_conta'");
...
<body>
	...
	<div class="mx-2">
		...
		<?php
		$total_entradas = 0;
		$query = $pdo->query("SELECT * FROM receber where tipo = 'Serviço' and pago = 'Sim' and pessoa = '$id' and id_conta = '$id_conta' ORDER BY data_pgto desc");
